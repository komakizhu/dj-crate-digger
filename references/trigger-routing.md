...
1. If the message contains a clear DJ planning action plus context—such as building a set, mixing, performing, a venue, dancefloor, warm-up, peak-time, closing, genre direction, reference artist/track, BPM, mood, or energy—activate for the full two-round flow. A bare `DJ` is not enough.
...
Once activated, do not search or recommend before the second intake round is answered. A post-report feedback, export, memory, or harmonic-order action is not a new intake round.
